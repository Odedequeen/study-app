...
import thumb3 from '../../assets/Images/Gallary/Gallary3.png'
...
export default function MostPopular(){
  const posts = [
    {img:thumb1, title:'Understanding Modern Education', excerpt:'A brief look into modern teaching methods and classroom dynamics.'},
    {img:thumb2, title:'Top Study Techniques', excerpt:'Proven study techniques to improve retention and exam performance.'},
    {img:thumb3, title:'Career Guidance Tips', excerpt:'How to choose the right path after finishing your course.'}
  ]
